...
public class RangerSystemAccessControl
  ...
  private boolean checkPermission(RangerPrestoResource resource, SystemSecurityContext context, PrestoAccessType accessType) {
    boolean ret = false;
  ...
  public void checkCanSetSystemSessionProperty(SystemSecurityContext context, String propertyName) {
    if (!checkPermission(new RangerPrestoResource(), context, PrestoAccessType.ADMIN)) {
